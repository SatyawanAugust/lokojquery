...
elseif ($_GET['module']=='detailberita'){
  ...
  // Apabila ada gambar dalam berita, tampilkan   
 	if ($d['gambar']!=''){
		echo "<p><span class=image><img src='foto_berita/$d[gambar]' border=0 width=360></span></p>";
	}
...
elseif ($_GET['module']=='detailkategori'){
  ...
  // Tampilkan daftar berita sesuai dengan kategori yang dipilih
   ...
   while($r=mysql_fetch_array($hasil)){
		...
		echo "<span class=date><img src=$f[folder]/images/clock.gif> $r[hari], $tgl - $r[jam] WIB</span><br />";
